...
function sendMessage(){
    ...
    typing.id = "typing";
    typing.textContent = "Zoryn sedang mengetik...";
    ...
    setTimeout(() => {
        ...
        botMsg.textContent = "Zoryn: " + getReply(text);
...
function getReply(message){
    ...
    if(message.includes("siapa kamu"))
        return "Aku Zoryn AI versi 0.02.";
...
function clearChat(){
    ...
    '<div class="bot-message">Halo! Aku Zoryn AI v0.02 🤖</div>';
